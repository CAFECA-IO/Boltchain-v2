export default {
  ...
  main: {
    ...
    why: {
      ...
      description1:
        "Transactions are performed at high speed off-chain, transaction content is protected by cryptography and smart contracts.",
      title2: "高擴容性",
      description2:
        "透過索引莫克樹技術實現百萬等級頻寬，解決公有鏈速度過慢的問題，是世界最佳公有鏈擴容方案。",
      title3: "High compatibility",
      description3:
        "Boltchain is a security protocol that can interact with any blockchain that supports smart contracts.",
      title4: "High practicality",
      description4:
        "Boltchain can provide a global consensus level of trust without destroying the centralized structure of your systems.",
      title5: "零手續費",
      description5:
        "Boltchain 金流加速器，透過智能合約及密碼學科學配合運作，讓使用者能享受高速無手續費的交易體驗。",
      title6: "高隱私性",
      description6:
        "交易完成時產生IMT切片給交易產生者(用戶)。僅用戶本人能透過切片檢閱交易內容，隱私有保障。",
    },
    case: {
      title: "Use Cases",
    ...
    news: {
      ...
      post2: {
        title:
          "Boltchain and Its Pioneering Role in Decentralizing the Global Business",
        time: "23 AUG 2019",
      ...
      post3: {
        title:
          "維港區塊鏈來台舉辦投資沙龍，高度評價泰德陽光集團 Boltchain 技術",
        time: "25 MAR 2019",
    ...
    team: {
      ...
      member1: {
        ...
        description:
          "Over 10 years of experience in distributed computing systems. He has been planned for large-scale software computing platform architecture for the higher education system of Oman, the cloud computing system of the China Software Park, and the Taiwan Industrial Foundation Project.",
      },
      member2: {
        ...
        description:
          "Bachelor of Engineering Management from Taiwan Tsing-hua University. Specializing in market analysis and enterprise service design. With 8 years of product management experience, has been responsible for product planning and project management in the world’s top 100 companies and Internet startups.",
      },
      member3: {
      ...
      member4: {
        ...
        description:
          "With 3 years of back-end development experience, he has worked for a well-known input method company in Taiwan, developing natural input methods with C # and C ++. Currently responsible for API development of Boltchain platform services.",
      },
      member5: {
        ...
        title: "Back-end Engineer",
        description:
          "Responsible for the back-end development and deployment of the system. He paid attention to the back-end developers of various open source communities, and has held Javascript community gatherings for many times.",
      },
      member6: {
        ...
        description:
          "With 3 years of front-end development experience, he is good at implementing the Javascript web interface and is involved in implementing multiple DApps. He is mainly responsible for the interface development of Boltchain services.",
      },
      member7: {
        ...
        title: "Front-end Engineer",
        description:
          "She was involved in the cloud software development, responsible for front-end interface development, and was familiar with user experience design. She was also responsible for performing user research and user interface testing.",
      },
    },
    contact: {
      title: "Contact Us",
      ...
      address:
        "9F., No. 156, Sec. 3, Minsheng E. Rd., Songshan Dist., Taipei City 105, Taiwan",
  ...
  trust: {
    title: "Bolt Trust – Product Cert",
    block1: {
      title:
        "The Traceability Service – Applying Boltchain to Achieve Products Verification and Traceability",
      image1: "./../img/2019/07/bolttrust_b-1.png",
      image2: "./../img/2019/07/bolttrust_map_en-1.png",
    },
    block2: {
      title:
        "Consumption disputes? The history of consumption is no more difficult to trace",
      image1: "./../img/2019/07/boltrust_icon_01.png",
      subtitle1: "To certify through blockchain",
      description1:
        "Huge amount of goods data and transactions can be attached on multiple public chains at very fast speed and low cost.",
      image2: "./../img/2019/07/boltrust_icon_02.png",
      subtitle2: "To make data credible",
      description2:
        "An authorized key is applied to control the user identity, ensuring that the production and sales records can be traced.",
      image3: "./../img/2019/07/boltrust_icon_03.png",
      subtitle3: "To enjoy a User-friendly Interface",
      description3:
        "User-friendly interface provides browser service generating certificates to easily communicate with users on how the trust system processes.",
    },
    block3: {
      title: "Bolt Trust import process",
      image: "./../img/2019/08/bolttrust_graphic_en-1.png",
    },
    block4: {
      title: "Commodity certificate on blockchain",
      image: "./../img/2019/08/devices_mockups-free-1.png",
    },
    block5: {
      title: "Identification steps",
      image: "./../img/2019/08/8_en.png",
      subtitle:
        "As long as you see the Bolt Trust Certificate, this means that this is genuine, and vice versa. The identification process is:",
      li1: "Scan QRCode or NFC Tag with your phone.",
      li2: "Check the identification number on Boltchain.",
      li3: "Check if the product publisher is an authorized key address.",
      li4: "Deep traceability to view information on product sales and sales.",
      li5: "Verify this product is genuine or fake!",
    },
    block6: {
      title: "Contact Us",
      contactTitle: "Contact Infomation",
      address:
        "9F., No. 156, Sec. 3, Minsheng E. Rd., Songshan Dist., Taipei City 105, Taiwan (R.O.C.)",
      phone: "+886 2-2700-1979",
      email: "service@boltchain.io",
      link: {
        facebook: "/",
      ...
      form: {
        info: `If you wish to propose business collaborations or discuss any of our products,
        please write to us and we will reply as quickly as possible. Thank you!`,
        name: "Your Name*",
        phone: "Phone Number",
        email: "Email*",
  ...
  currency: {
    ...
    block1: {
      title:
        "Issuing digital currency - use Bolt Token to build your token economy",
    ...
    block2: {
      ...
      description1:
        "Use Bolt Token to build the points economy, points can be freely exchanged through the blockchain wallet.",
      image2: "./../img/2020/boltcurrency/boltcurrency_02.png",
      subtitle2: "Activate Asset",
      description2:
        "Tokenize your commodities or assets and manage them with smart contracts to meet different business needs such as crowdfunding.",
      image3: "./../img/2020/boltcurrency/boltcurrency_03.png",
      subtitle3: "Connect Blockchain",
      description3:
        "Use Bolt Token to connect to blockchains, so you can easily integrate your application with the blockchain.",
    },
    block3: {
    ...
    block5: {
      ...
      subtitle2:
        "Then, start to manage your Bolt Token through the built-in wallet！",
    },
    block6: {
      title: "Contact Us",
      contactTitle: "Contact info",
  ...
  technology: {
    title: "Technology",
    block1: {
      title: "Boltchain vs. Other Public Chains vs. Private Chains",
      table: {
        B1: "Public Chains",
        C1: "Private Chains",
        D1: "Hybrid Public Chain",
        B2: "Bitcoin",
        C2: "Ethereum",
        D2: "POS, PBFT or POA consensus protocols",
        E2: "Boltchain",
        A3: "Number of Nodes",
        B3: "Unlimited (currently around 8k~10k)",
        C3: "Unlimited (currently around 8k~10k)",
        D3: "Limited",
        E3: "Unlimited",
        A4: "Achieves global consensus",
        B4: "Yes",
        C4: "Yes",
        D4: "No",
        E4: "Yes",
        A5: "51% attack",
        B5: "Nearly impossible",
        C5: "Nearly impossible",
        D5: "Easily",
        E5: "Nearly impossible",
        A6: "TPS",
        B6: "≒7",
        C6: "≒25",
        D6: "1,000~2,000",
        E6: ">2,000",
        A7: "Blockchain Bloat Problem",
        B7: "No",
        C7: "Yes",
        D7: "Yes (Severely)",
        E7: "No",
        ...
        D8: "Limited",
        E8: "Complete",
        A9: "Compatible with centralized ecosystems",
        B9: "No",
        C9: "No",
        D9: "No",
        E9: "Yes",
        A10: "Fast Off-chain Ledger Auditing",
        B10: "No",
        C10: "No",
        D10: "No",
        E10: "Yes",
    ...
    block2: {
      ...
      image: "/img/2019/09/technology_01_02.png",
    },
    block3: {
      title: "Hybrid-chain evidence",
      description:
      ...
      image: "/img/2019/07/technology_02.png",
    },
    block4: {
      title: "Cross-chain Channel (C3)",
      description: `The cross-chain channel uses an intermediary micro-service communication to two blockchains that have a Turing-complete. The micro-service can simultaneously access the information of the two-sided blockchain and has a private key to prevent the processing information from being forged.
It converts the data exchange or asset exchange conditions between the two blockchains into executable programming languages, and sets the conditional specification for the cancellation of the transaction, which will be relevant when either blockchain triggers the event.The certificate is submitted to the other party block chain for execution.`,
      ...
      image: "/img/2019/08/boltchain_system_04-1.-1.png",
    },
  },
  faq: {
    title: "FAQ",
    question1: "What industries can apply Boltchain technology?",
    answer1:
    ...
    question2: "Why use Boltchain?",
    answer2:
      "Boltchain can solve the obstacles that are currently preventing the use of blockchain in central systems, including bandwidth, privacy, and convenience. And it uses mainstream public chains to provide extremely high global consensus and permanence.",
    question3: "What are the technical features of Boltchain?",
    answer3: "Hybrid-chain evidence and Cross-chain Channel (C3) protocol.",
    question4: "Why can Boltchain significantly reduce on-chain costs?",
    answer4:
      "Boltchain uses an Off-chain compression technology to operate all transactions outside the main chain and generate a hash value before recording it back onto the main chain. These layers reach a consensus with the main chain to secure and increase the data to put on chain.",
    question5: "Why Boltchain provides post audit method?",
    answer5:
      "When the hash value of the booster is recorded back into the main chain, the participants is unable to be informed of the consistency of results, so we used distributed auditing techniques and easy-to-use tool to meet their audit needs.",
    question6:
      "What is Boltchain different from other cross-chain & sidechain technologies?",
    answer6:
      "There are three main categories of side chain technology: relay chain types, lower channel types, and hierarchical side chains.  Boltchain not only solves the problems of the first three traditional side-chain technologies, but also further provides applications such as central service interfaces and cross-chain value swap.",
  },
};
