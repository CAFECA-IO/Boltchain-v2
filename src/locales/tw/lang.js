export default {
  ...
  main: {
    ...
    why: {
      ...
      title1: "高速支付",
      description1:
        "交易皆在鏈下進行高速運算，交易內容受到密碼學及智能合約保護，安全交易僅在毫秒之間。",
      title2: "高擴容性",
      description2:
        "透過索引莫克樹技術實現百萬等級頻寬，解決公有鏈速度過慢的問題，是世界最佳公有鏈擴容方案。",
      title3: "高兼容性",
      description3:
        "Boltchain 是可與任何支援智能合約的區塊鏈互動的安全協定，連接以太坊、比特幣毫無問題！",
      title4: "高實用性",
      description4:
        "Boltchain 是代理人模式的安全協定，可在不破壞企業既有管轄架構前提下，提供全球共識等級的信任。",
      title5: "零手續費",
      description5:
    ...
    team: {
      ...
      member1: {
        ...
        title: "首席系統架構師",
        description:
          "畢業於成功大學，擁有超過十年分散式運算系統研發經驗。曾負責規劃阿曼教育部高等教育系統、中國軟體園區雲計算系統、台灣工業基礎計畫等大型軟體運算平台架構。",
      },
      member2: {
        ...
        title: "資深產品經理",
        description:
          "畢業於清華大學工業工程與工程管理學系，擅長市場需求分析與企業服務設計。有八年產品管理經驗，曾分別於全球百大企業、互聯網新創公司負責產品規劃與專案管理。",
      },
      member3: {
        ...
        title: "資深介面設計師",
        description:
          "曾任職於全球最大廣告傳播集團 WPP 旗下廣告公司，擁有十年以上設計經驗。參與過多項大型設計案，目前負責主導 Boltchain 風格設計與 UI 整體規劃。",
      },
      member4: {
        ...
        title: "後端工程師",
        description:
          "擁有三年後端開發經驗，曾任職台灣知名輸入法公司，以 C#、C++ 開發自然輸入法。現負責 Boltchain 平台服務所需 API 開發。",
      },
      member5: {
        ...
        title: "後端工程師",
        description:
          "負責系統後端開發與部署，學生時期即開始關注各開源社群的後端開發者，多次舉辦 Javascript 社群聚會，曾任 SITCON 年會講師。",
      },
      member6: {
        ...
        title: "前端工程師",
        description:
          "擁有三年前端開發經驗，擅長實作 Javascript Web 介面，並參與實作多支 DApp，主要負責 Boltchain 產品服務之前端介面開發。",
      },
      member7: {
        ...
        title: "前端工程師",
        description:
          "曾參與規劃及開發雲端服務軟體，負責前端介面設計與開發，同時熟悉使用者經驗設計，也負責執行使用者研究與使用者介面測試。",
      },
    },
    contact: {
      title: "企業諮詢",
  ...
  trust: {
    title: "Bolt Trust 商品認證追溯",
    block1: {
      title: "商品溯源服務 - 應用區塊鏈技術的商品認證與追溯方案",
      image1: "./../img/2019/07/bolttrust_b-1.png",
      image2: "./../img/2019/07/bolttrust_map_tw-2.png",
    },
    block2: {
      title: "商品消費糾紛？作假掉包？不用再擔心源頭難以追溯",
      image1: "./../img/2019/07/boltrust_icon_01.png",
      subtitle1: "高效上鏈",
      description1: "大量商品資料與交易紀錄，能以極低成本上多條公鏈存證",
      image2: "./../img/2019/07/boltrust_icon_02.png",
      subtitle2: "資料可信",
      description2:
        "用授權金鑰管控寫入者身份，確保產銷記錄可追溯，打通各環節間信任",
      image3: "./../img/2019/07/boltrust_icon_03.png",
      subtitle3: "介面友善",
      description3:
        "友善的區塊鏈瀏覽介面與存證證書，幫助消費者理解商品溯源履歷",
    },
    block3: {
      title: "追溯服務導入流程",
    ...
    block5: {
      title: "消費者鑑真步驟",
      image: "./../img/2019/08/8-2.png",
      subtitle:
        "只要看到 Bolt Trust Certificate 證書即表示此為真品，反之可能為贗品，驗證流程為：",
      li1: "使用手機掃描 QRCode 或者 NFC Tag",
      li2: "自動查驗 Boltchain 上的商品證號",
  ...
  currency: {
    ...
    block2: {
      ...
      subtitle1: "虛擬點數",
      description1:
        "用 Bolt Token 實現點數經濟，點數之間可自由交換，透過區塊鏈錢包交易。",
      image2: "./../img/2020/boltcurrency/boltcurrency_02.png",
      subtitle2: "資產活化",
      description2:
        "將你的商品或資產代幣化，以智能合約管理，滿足眾籌或切割販售等不同商業需要。",
      image3: "./../img/2020/boltcurrency/boltcurrency_03.png",
      subtitle3: "連結區塊鏈",
      description3:
        "使用 Bolt Token 即包含發行、交易、支付都連結區塊鏈，輕鬆將你的應用與區塊鏈整合。",
    },
    block3: {
  ...
  technology: {
    ...
    block2: {
      title: "技術原理",
      description:
        "Boltchain 是以 Layer 2 protocal 方式，將數筆交易的鏈下證據，經過壓縮形成加密雜湊值，通過 跨鏈協議 上到 Ethereum、Bitcoin 等公鏈。藉此解決公鏈交易速度慢、延展性不足問題。",
      image: "./../img/2019/09/technology_01_01.png",
    },
    block3: {
      title: "混合鏈證據",
      description:
        "Boltchain 將可閱讀的資料分解為多筆 Transaction 紀錄，以雜湊演算法使用 Indexed Merkle Tree 將之抽象形成區塊鏈證據，並將此最終證據 (root hash形式) 同時保留至 Ethereum、Bitcoin等複數個公鏈，證據保存之安全性會隨證據發布的公鏈數量指數性成長。",
      image: "./../../img/2019/07/technology_02.png",
    },
    block4: {
      title: "跨鏈通訊協議 (C3)",
      description: `跨鏈通訊協議使用一中介微服務溝通兩者具備圖靈完備的區塊鏈，該微服務可以同時存取兩邊區塊鏈的資訊，並具備私鑰避免其處理資訊受到偽造。其將兩條區塊鏈之間的資料交換或資產交換條件轉換為兩條區塊鏈上可執行的程式語言，並設定交易生效取消的條件規範，當任一方區塊鏈觸發事件時將相關證據提交至另一方區塊鏈執行。`,
      subtitle: "跨鏈資產交換：",
      description2:
        "使用跨鏈通訊協議與 Layer 2 Protocol 將其他區塊鏈上的資產移轉至 Boltchain 系統運作，藉此達成多元區塊鏈價值流通。",
      image: "./../../img/2019/08/boltchain_system_04-1.-1.png",
    },
  },
  faq: {
    title: "常見問題",
    question1: "有哪些領域可以應用 Boltchain 技術？",
    answer1:
      "Boltchain 的設計能良好介接企業的中央式系統與公有區塊鏈，讓企業能有效使用區塊鏈建立相關應用。在一般商業環境中，有中間人服務，或需要監管機關介入，無法完全去中心化時，我們可以解決用戶和中間人資訊不對等的問題，包含數位內容的版權管理、金融產業等。",
    question2: "為什麼要使用 Boltchain？",
    answer2:
      "Boltchain 可以解決目前企業中央式系統對於區塊鏈的使用障礙，包含頻寬、隱私以及便利，並以主流公鏈來提供極高的全球共識與永久性。",
    question3: "Boltchain 的技術特色是什麼？",
    answer3: "混合鏈證據以及跨鏈通訊協議 (C3)。",
    question4: "Boltchain 為什麼可以大幅降低上鏈成本？",
    answer4:
      "Boltchain 使用鏈下壓縮技術，將所有的交易都在主鏈外運作後，產生一個雜湊值後才紀錄回主鏈，以上層主鏈達成共識保護安全。",
    question5: "Boltchain 可以提供事後稽核？",
    answer5:
      "當加密雜湊值紀錄到主鏈後，參與者不易得知結果一致性，因此我們提供簡易的事後稽核技術與工具，來滿足鏈下對鏈上資料稽核需求。",
    question6: "Boltchain 跟其他跨鏈/側鏈技術有哪裡不同？",
    answer6:
      "側鏈技術主要有三大類：中繼鏈類型、鏈下通道類型以及階層型側鏈。Boltchain不僅解決前三種傳統側鏈技術的問題，並能進一步提供中央式服務介接以及跨鏈價值轉換等應用。",
  },
};
